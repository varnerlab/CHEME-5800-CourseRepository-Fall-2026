...
# `Week14Core` holds this meeting's own source. It is wrapped in a module so that
...
if !isdefined(@__MODULE__, :Week14Core)
    include(joinpath(@__DIR__, "..", "src", "Week14Core.jl"))
end
...
using .Week14Core   # from the include in section 2
