...
if !isdefined(@__MODULE__, :CHEME5800_L11C_ROOT)
    const CHEME5800_L11C_ROOT = @__DIR__
end
...
include(normpath(joinpath(CHEME5800_L11C_ROOT, "..", "..", "..", "Include.jl")))

# `Week11Core` holds this meeting's own source. It is wrapped in a module so that
...
if !isdefined(@__MODULE__, :Week11Core)
    include(normpath(joinpath(CHEME5800_L11C_ROOT, "..", "src", "Week11Core.jl")))
end
...
using .Week11Core    # from the include in section 2
