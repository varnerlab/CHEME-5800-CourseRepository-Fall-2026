...
if !isdefined(@__MODULE__, :CHEME5800_L11B_ROOT)
    const CHEME5800_L11B_ROOT = @__DIR__
end
...
include(normpath(joinpath(CHEME5800_L11B_ROOT, "..", "..", "..", "Include.jl")))
...
if !isdefined(@__MODULE__, :Week11Core)
    include(normpath(joinpath(CHEME5800_L11B_ROOT, "..", "src", "Week11Core.jl")))
end
