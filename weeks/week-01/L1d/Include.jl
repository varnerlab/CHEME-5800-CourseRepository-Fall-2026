...
# `L1dFloatingPoint` holds this meeting's own source. It is wrapped in a module so that
...
if !isdefined(@__MODULE__, :L1dFloatingPoint)
    include(joinpath(CHEME5800_L1D_ROOT, "src", "Compute-solution.jl"))
end
...
using .L1dFloatingPoint  # from the include in section 2
