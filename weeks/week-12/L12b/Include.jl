...
if !isdefined(@__MODULE__, :CHEME5800_L12B_ROOT)
    const CHEME5800_L12B_ROOT = @__DIR__
end
...
include(normpath(joinpath(CHEME5800_L12B_ROOT, "..", "..", "..", "Include.jl")))
...
if !isdefined(@__MODULE__, :Week12Core)
    include(normpath(joinpath(CHEME5800_L12B_ROOT, "..", "src", "Week12Core.jl")))
end
