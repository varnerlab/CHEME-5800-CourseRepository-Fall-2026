% Adapted from Jeffrey D Varner (2026), MRW-BTC4-Chapter-Varner.
% Source commit: 881056b3c3c57d83036f2c219d81c848d763118d. See LICENSE.
% Changes: lecture bound notation, exact parallel contours, notebook themes.
...
\begin{scope}[shift={(11.70,0)}]
  ...
  \begin{scope}
    ...
    \draw[contour] (1.15,0.20) -- (0.00,{.20+1.15*10/3});
    \draw[contour] (2.45,0.20) -- (1.30,{.20+1.15*10/3});
    \draw[contour] (3.72,0.20) -- (2.57,{.20+1.15*10/3});
  \end{scope}
