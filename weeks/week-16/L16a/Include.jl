...
# `Week16Core` holds this meeting's own source. It is wrapped in a module so that
...
if !isdefined(@__MODULE__, :Week16Core)
    include(joinpath(@__DIR__, "..", "src", "Week16Core.jl"))
end
...
using .Week16Core   # from the include in section 2
