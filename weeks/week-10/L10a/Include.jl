...
if !isdefined(@__MODULE__, :CHEME5800_L10A_ROOT)
    const CHEME5800_L10A_ROOT = @__DIR__
end
...
include(normpath(joinpath(CHEME5800_L10A_ROOT, "..", "..", "..", "Include.jl")))
...
if !isdefined(@__MODULE__, :Week10Core)
    include(normpath(joinpath(CHEME5800_L10A_ROOT, "..", "src", "Week10Core.jl")))
end
