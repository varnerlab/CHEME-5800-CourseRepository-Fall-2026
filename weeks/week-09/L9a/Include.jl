...
if !isdefined(@__MODULE__, :CHEME5800_L9A_ROOT)
    const CHEME5800_L9A_ROOT = @__DIR__
end
...
include(normpath(joinpath(CHEME5800_L9A_ROOT, "..", "..", "..", "Include.jl")))
...
if !isdefined(@__MODULE__, :Week09Core)
    include(normpath(joinpath(CHEME5800_L9A_ROOT, "..", "src", "Week09Core.jl")))
end
