...
using a documented UCI dataset. The perceptron and weighted logistic regression use the same
...
| L9b | Predictive-maintenance classification with a perceptron | [Optional XOR example](L9b/CHEME-5800-L9b-Example-XORLinearSeparability-Fall-2026.ipynb) |
...
| L9d | Predictive-maintenance model comparison | [Lab](L9d/CHEME-5800-L9d-Lab-PredictiveMaintenance-Fall-2026.ipynb) |
...
the data loader, narrative, split, metrics, and models are now predictive-maintenance-specific and
