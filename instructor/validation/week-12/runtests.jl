...
released("L12a") && include(joinpath(@__DIR__, "..", "..", "..", "weeks", "week-12", "L12a", "Include.jl"))
released("L12b") && include(joinpath(@__DIR__, "..", "..", "..", "weeks", "week-12", "L12b", "Include.jl"))
released("L12c") && include(joinpath(@__DIR__, "..", "..", "..", "weeks", "week-12", "L12c", "Include.jl"))
released("L12d") && include(joinpath(@__DIR__, "..", "..", "..", "weeks", "week-12", "L12d", "Include.jl"))

@meeting "L12a" "L12b" "L12c" "L12d" begin
