...
released("L15a") && include(joinpath(@__DIR__, "..", "..", "..", "weeks", "week-15", "L15a", "Include.jl"))
released("L15b") && include(joinpath(@__DIR__, "..", "..", "..", "weeks", "week-15", "L15b", "Include.jl"))
released("L15c") && include(joinpath(@__DIR__, "..", "..", "..", "weeks", "week-15", "L15c", "Include.jl"))
released("L15d") && include(joinpath(@__DIR__, "..", "..", "..", "weeks", "week-15", "L15d", "Include.jl"))

@meeting "L15a" "L15b" "L15c" "L15d" begin
