...
released("L11a") && include(joinpath(@__DIR__, "..", "..", "..", "weeks", "week-11", "L11a", "Include.jl"))
released("L11b") && include(joinpath(@__DIR__, "..", "..", "..", "weeks", "week-11", "L11b", "Include.jl"))
released("L11c") && include(joinpath(@__DIR__, "..", "..", "..", "weeks", "week-11", "L11c", "Include.jl"))
released("L11d") && include(joinpath(@__DIR__, "..", "..", "..", "weeks", "week-11", "L11d", "Include.jl"))

@meeting "L11a" "L11b" "L11c" "L11d" begin
